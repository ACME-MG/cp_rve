...
class EVPWD(model.Model):
    ...
    def __init__(self):
        ...
        super().__init__(
            name = "evpwd",
            param_info = [
                {"name": "evp_s0",  "min": 1.0e1,   "max": 5.0e1},
                {"name": "evp_R",   "min": 1.0e1,   "max": 1.0e2},
                {"name": "evp_d",   "min": 1.0e1,   "max": 5.0e1},
                {"name": "evp_n",   "min": 1.5e0,   "max": 2.0e0},
                {"name": "evp_eta", "min": 1.0e4,   "max": 1.0e6},
                {"name": "wd_wc",   "min": 4.0e1,   "max": 5.0e1},
